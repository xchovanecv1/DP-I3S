...
type MockAuthStore struct {
	GetAccountFn      func(id int) (*models.Account, error)
	GetAccountInvoked bool

	GetAccountByEmailFn      func(email string) (*models.Account, error)
...
func (s *MockAuthStore) GetAccount(id int) (*models.Account, error) {
	s.GetAccountInvoked = true
	return s.GetAccountFn(id)
}

// GetAccountByEmail mock returns an account by email.
func (s *MockAuthStore) GetAccountByEmail(email string) (*models.Account, error) {
...
func (s *MockAuthStore) UpdateAccount(a *models.Account) error {
