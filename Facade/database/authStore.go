...
func (s *AuthStore) GetAccount(id int) (*models.Account, error) {
...
func (s *AuthStore) GetAccountByEmail(e string) (*models.Account, error) {
...
// GetAccountByUUID returns an account by email.
func (s *AuthStore) GetAccountByUUID(u string) (*models.Account, error) {
	a := models.Account{UUID: u}
	err := s.db.Model(&a).
		Column("account.*").
