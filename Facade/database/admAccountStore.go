...
func (s *AdmAccountStore) List(f *AccountFilter) ([]models.Account, int, error) {
	a := []models.Account{}
...
func (s *AdmAccountStore) GetByUUID(uuid string) (*models.Account, error) {
...
func (s *AdmAccountStore) GetByRole(rl string) (*models.Account, error) {
	var role [1]string
	role[0] = rl
